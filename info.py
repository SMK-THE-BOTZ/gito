...
BOT_TOKEN = environ.get('BOT_TOKEN', "7202842643:AAF4QVON6Zy3ptuUQqOz18HK-ervekk_sdY")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002173648219') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002173648219')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002173648219')
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', LOG_CHANNEL))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002173648219')).split()]
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "postgres://koyeb-adm:UaKRw9J5ETrZ@ep-flat-sky-a21czntf.eu-central-1.pg.koyeb.app/koyebdb")
DATABASE_NAME = environ.get('DATABASE_NAME', "koyeb-adm")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Mr_PERSIS_SUPPORT_GROUP')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Mr_PERSIS_BOT')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Mr_PERSIS_BOT')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Mr_PERSIS_SUPPORT_GROUP') # Support Chat Link Without https:// or @
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://gito.onrender.com/")
